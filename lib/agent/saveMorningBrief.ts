...
export function morningBriefToMarkdown(brief: MorningBrief): string {
  ...
  return [
    ...
    "",
    section("Global AI Chain Changes", brief.globalAiChainChanges),
    "",
    section(
      "China 国产替代 Changes",
    ...
    "",
    section("AI Infrastructure Risk Signals", brief.aiInfrastructureRiskSignals),
    "",
    section("AI Capex and Datacenter Signals", brief.aiCapexDatacenterSignals),
    "",
    section(
...
export function savedMorningBriefToBrief(
  ...
  return {
    ...
    globalAiChainChanges: getSectionLines(content, "Global AI Chain Changes"),
    chinaDomesticSubstitutionChanges: getSectionLines(
      content,
      "China 国产替代 Changes",
    ),
    narrativeAccelerationFading: getSectionLines(
      content,
      "Narrative Acceleration / Fading",
    ),
    thesisReinforcementContradiction: getSectionLines(
      content,
      "Thesis Reinforcement / Contradiction",
    ),
    aiInfrastructureRiskSignals: getSectionLines(
      content,
      "AI Infrastructure Risk Signals",
    ),
    aiCapexDatacenterSignals: getSectionLines(
      content,
      "AI Capex and Datacenter Signals",
    ),
    importantCompanyMemoryUpdates: getSectionLines(
      content,
      "Important Company Memory Updates",
    ),
